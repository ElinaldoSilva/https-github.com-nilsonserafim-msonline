...
@section('style')
    .bg-red {
        background-color: #cf730026 !important;
    }
@endsection
    ...
    <div class="container-fluid px-md-4 pb-4">
                    ...
                    <div class="input-group input-group-sm mb-2 st-01 d-xs-block">
                      ...
                      <div class="form-control d-contents" >
                        <div class="custom-control custom-radio ms-xs-2" style="min-width: 64px;">
                            <input type="radio" class="custom-control-input" checked id="urna_anjo" name="tipo_urna" value="ANJO" >
        ...
        <div class="card mt-3" style="{{ (date('H') > '18' &&  Auth::user()->nivel==9)  ? 'display:none' : ''  }}">
            ...
            <div class="table-responsive">
                <table class="table table-bordered border-dark mb-0" style="border-bottom: 3px solid;">
...
<!--
        ...
        @if ( Auth::user()->nivel==9 && count($regAgendamentos) > 0 )
        <br>
        <div class="card row pt-3 pb-1 px-2 shadow mx-auto my-4 container-800" style="zoom:0.88;">
            <div class="card-header text-center bold ft-22 c-azul">{{ __('SEUS AGENDAMENTOS') }}</div>
                ...
                <table class="table">
                  <thead class="table-dark">
                    <tr>
                      ...
                      <th scope="col" class="text-left">FALECIDO</th>
                    </tr>
                  </thead>
                  ...
                  <tbody id="rel_agendamentos">
                    ...
                    @foreach($regAgendamentos as $agendamento)
                      @if($age!=$agendamento->DataSepultamento)
                          <tr>
                            <td colspan="4" style="padding: 0 !important; height: 4px;"><hr style="height: 2px; margin: 0; opacity: 0.35;"></td>
                          <tr>
                      @endif
                      @php
                      ...
                      <tr>
                        ...
                        <td class="pad-01 text-left fal">{{ $agendamento->Falecido }}</td>
                      </tr>
                    @endforeach
                  </tbody>
    ...
    function verifica_reservas()
    {
        ...
        $.ajax(
        {
            ...
            {  
                ...
                $(".aj10.horario-indisponivel").each(function(i, e)
                {
...
/*                if(retorno.capela=="DIRETO")
                {
                    texto += "DIRETO";
                } else {
                    texto += "Capela: " + retorno.capela;
                }
                texto += "</strong></center><br>Protocolo:<strong> " + retorno.protocolo + "</strong><br><br></span></div>";
*/
                if (retorno.status==1) {
